...
{!! Form::label('opening', 'البيانات الإفتتاحية') !!}</div>
 <div class="col-md-5 col-md-offset-1 success">
					...
					{!! Form::text('opening_creditor', Input::old('opening_creditor'), array('class' => 'form-control')) !!}
					</div>
</div>
<div class="col-md-6">
					<div class="form-group">
					{!! Form::label('opening_debtor', trans('customer.debtor')) !!}
					{!! Form::text('opening_debtor', Input::old('opening_debtor'), array('class' => 'form-control')) !!}
					</div>
					</div>
